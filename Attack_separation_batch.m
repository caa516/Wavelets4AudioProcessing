...
files = dir('/Users/CarlosArchila/Documents/University/UoY/Year4/MEng_Project/Samples/Trumpet.novib.ff.stereo/*.aif');
folder = extractfield(files, 'folder')';
name = extractfield(files, 'name')';
filepath = cell(length(files),1);
for i=1:length(files)
    filepath(i) = strcat(folder(i),{'/'},name(i));
end
%%
